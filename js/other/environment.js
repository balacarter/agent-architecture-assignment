 ...
 * 7-5-2016      Gustavo Dias    Animation delay implementation
 **********************************************************************
*/
...
Environment.runAgents = function (graphData){
    ...
    if (document.getElementById("animationDelay").checked) {
        animationDelay = document.getElementById("animationDelayValue").value;
    }
    ...
    movementInterval = setInterval(function() {
    	...
    	if (!running || untouchable) {
    		...
    		for(var i = 0; i < numberOfAgents ; i++){
    			animationAgents[i].animateTo(agents[i].currentNode.x + 1, agents[i].currentNode.y + 3);
    		}
