...
Vertex.value1Color = "#cee4d5";
Vertex.value2Color = "#9cc9ab";
Vertex.value3Color = "#6aaf81";
Vertex.value4Color = "#48855c";
Vertex.obstacleColor = "#f27c23";
...
Vertex.prototype.colorAsObstacle = function(){
	$(this.id).css("background-image", 'url(images/obstacleLayerBug.jpg)');
	this.valueLevel = -1;
...
Vertex.prototype.colorAsNormal = function () {
	...
	if (this.valueLevel == -1){
		$(this.id).css("background-image", 'url(images/0LayerBug.jpg)');
		this.valueLevel = 0;
		this.isObstacle = false;
	}
...
Vertex.prototype.colorAsValue = function () {
	...
	if (this.valueLevel == 0){
		$(this.id).css("background-image", 'url(images/1LayerBug.jpg)');
		this.valueLevel = 1;
		return 1;
	}
	
	else if (this.valueLevel == 1){
		$(this.id).css("background-image", "url(images/2LayerBug.jpg)");
		this.valueLevel = 2;
		return 1;
	}
	
	else if (this.valueLevel == 2){
		$(this.id).css("background-image", "url(images/3LayerBug.jpg)");
		this.valueLevel = 3;
		return 1;
	}
	return 0;
...
Vertex.prototype.childrenAtPlay = function () {
	if(this.valueLevel < 3 && this.valueLevel >= 0){
		...
		$(this.id).css("background-image", "url(images/4LayerBug.jpg)");
		this.valueLevel += 1;
		return 1;
	}
	return 0;
